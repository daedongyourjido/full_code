      ...
      <Stack direction="row" spacing={2}>
        <Button
          ...
          onClick={() => {
            ...
            else if (props.id) props.setIdEmpty(false);
            if (!props.pw) props.setPwEmpty(true);
            if (!props.name) props.setNameEmpty(true);
            else if (props.pw) props.setPwEmpty(false);
            if (props.pw.length < 8) props.setPwWrong(true);
            else if (props.pw.length >= 8) props.setPwWrong(false);
            if (!props.pwDup) props.setPwCheckEmpty(true);
