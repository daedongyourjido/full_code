...
import "@styles/views/setting/setting.css";
    ...
    <div className="setting-box">
      <div className="setting-menu-container">
        <div style={{ color: "gray", fontSize: "15px", marginLeft: "10px" }}>
          <p
            className={`${changeuserinfo} setting-change-user-info`}
            onClick={() => {
              navigate("/setting/change-user-info");
            }}
          >
            프로필 수정
          </p>
          <p
            className={`${change} setting-change`}
            onClick={() => {
          ...
          <p
            className={`${withdraw} setting-withdraw`}
