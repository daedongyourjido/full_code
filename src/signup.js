  ...
  return (
    <div style={{ width: "380px" }}>
      ...
      >
        ...
        {idEmpty ? (
          <SignUpIdErrorField setId={setId} />
        ) : idDupCheck ? (
          <SignUpIdField setId={setId} />
        ) : (
          <SignUpDisableField id={id} />
        )}
        {idEmpty ? (
        ...
        {nameEmpty ? (
          <SignUpNameEmptyField setName={setName} />
        ) : (
          <SignUpNameField setName={setName} />
        )}
        {pwEmpty ? (
          <SignUpPwErrorField setPw={setPw} />
        ) : pwWrong ? (
          <SignUpPwWrongField setPw={setPw} />
        ) : (
        ...
        {pwCheckEmpty ? (
          <SignUpPwCheckEmptyField setPwDup={setPwDup} />
        ) : pwCheck ? (
          <SignUpPwCheckErrorField setPwDup={setPwDup} />
        ) : (
        ...
        >
          <p style={{ color: "gray", fontSize: "10px", marginRight: "10px" }}>
            혹은 계정이 있는 경우
          </p>
          <a
            href="/login"
            style={{ color: "#045369", fontSize: "12px", margin: "7px" }}
          >
            Sign In
          </a>
        </div>
